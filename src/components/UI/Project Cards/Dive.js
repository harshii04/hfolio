  ...
  return (
    <>
      <div className="md:py-4">
        ...
        >
          <div className=" bg-[#f4f6f8] hover:bg-purple-card transition-all duration-300 ease-in-out md:py-12 md:px-8 py-8 px-4 flex flex-col gap-12 md:rounded-2xl rounded-lg">
            <div>
